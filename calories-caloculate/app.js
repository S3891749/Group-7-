...
const ItemCtrl = (function () {
  //item Constructor
  const Item = function (meal, calories) {
  ...
  return {
    ...
    addItem: function (meal, calories) {
      const newItem = new Item(meal, parseInt(calories));
    ...
    updateItemByID: function (id, meal, calories) {
